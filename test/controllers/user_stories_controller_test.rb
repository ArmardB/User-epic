...
class UserStoriesControllerTest < ActionController::TestCase
  ...
  test "should create user_story" do
    assert_difference('UserStory.count') do
      post :create, user_story: { param1: @user_story.param1, param2: @user_story.param2, param3: @user_story.param3, references: @user_story.references }
    end
  ...
  test "should update user_story" do
    patch :update, id: @user_story, user_story: { param1: @user_story.param1, param2: @user_story.param2, param3: @user_story.param3, references: @user_story.references }
    assert_redirected_to user_story_path(assigns(:user_story))
  end
